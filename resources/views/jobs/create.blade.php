    ...
    <div class="py-5 px-3">
        <form action="{{ route('jobs.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control d-inline-block w-auto" id="vacancies" name="vacancies"
                    value="{{ old('vacancies') }}">
                @error('vacancies')
                    <div class="alert alert-danger my-3">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control w-auto d-inline-block me-3" id="min_salary" name="min_salary"
                    value="{{ old('min_salary') }}">
                <input type="text" class="form-control w-auto d-inline-block me-3" id="max_salary" name="max_salary"
            ...
            <div class="mb-3 ">
                ...
                <input type="date" class="form-control w-auto d-inline-block" id="deadline" name="deadline"
                    ...
                    value="{{ \Carbon\Carbon::parse(old('deadline'))->format('Y-m-d') }}">
                @error('deadline')
                    <div class="alert alert-danger my-3">{{ $message }}</div>
                @enderror
            </div>
